...
<li class="nav-header">Kategori</li>
  ...
  <div class="topbox">
                  ...
                  <br>
				  <br>
				  <b>Pemesanan hanya dapat dilakukan oleh member</b>
                  <br/> 
				  <ul>
					<li> Pilih buku yang anda inginkan.</li>
					<li> Data buku dapat anda ketahui dari identitas detil buku.</li>
					<li> Kondisi buku terbagi menjadi 5 grade, dimulai dari grade A merupakan kondisi terbaik sampai grade E merupakan kondisi buku yang paling buruk.</li>
					<li> Semua buku yang tersedia masih layak untuk dipergunakan kembali, sekalipun berada pada grade E.</li>
                    <li> Pemesanan akan kami proses dan verifikasi melalui sms dan email.</li>
