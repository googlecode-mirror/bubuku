  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
          <center> <h1>WISHLIST</h1></center><br>
           <form class="form-horizontal">
  <div class="control-group">
    <label class="control-label" for="inputJudulBuku">Judul Buku</label>
    <div class="controls">
      <input type="text" id="inputJudulBuku" placeholder="Judul Buku">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="inputTahunTerbit">Tahun Terbit</label>
    <div class="controls">
      <input type="text" id="inputTahunTerbit" placeholder="Tahun Terbit">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="inputPenulis">Penulis</label>
    <div class="controls">
      <input type="text" id="inputPenulis" placeholder="Penulis">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="inputGrade">Grade</label>
    <div class="controls">
      <input type="text" id="inputGrade" placeholder="Grade">
    </div>
  </div>
  
<div class="control-group">
    <label class="control-label" for="inputBatasWaktu">Batas Waktu</label>
    <div class="controls">
      <input type="text" id="inputBatasWaktu" placeholder="Batas Waktu">
    </div>
  </div>
