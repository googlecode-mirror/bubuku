...
$toko_sesi = new toko();
$toko = new toko();
$toko_dao = new toko_Dao();
$data=$toko_dao->get_all();
...
<title>Toko Mitra</title>
</head>
<body background="img/white.jpg">
<body>
<div class="admin">
  <h1><font color="#333333">BUBUKU - <font color="#0000FF">Manajemen Toko</h1>
</div>
<!-- memuat menu -->
...
<table width="" border="1" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF">
                    ...
                    <th width="20"><span class="style4">No</span></th>
                      ...
                      <th width="200"><span class="style4">Telepon</span></th>
                      <th width="100"><span class="style4">Email</span></th>                
                      <th width="98">&nbsp;</th>
                    </tr>
				  ...
				  $toko_Dao=new toko_Dao();
				  $toko=$toko_Dao->get_id($toko->id_toko);
				  
				  ?>
             
                    <tr>
                    <td><span class="style3"><?php echo $i;?></span></td>
                      <td><span class="style3"><?php echo $toko->nama;?></span></td>
                      <td><span class="style3"><?php echo $toko->alamat;?></span></td>
                      <td><span class="style3"><?php echo $toko->telepon;?></span></td>
                      <td><span class="style3"><?php echo $toko->email;?></span></td>
                      <td><span class="style3"><?php echo $user->akses;?></span></td>
                      <td><?php echo "<a href=\"C_form_manajemen toko.php?id=$toko->id_toko\">";
					  echo "Edit toko</a> ";?></td>
